...
<style>
body {
   background: url(img/bg2.gif) center center fixed ;
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>โปรดกรอกอีเมลที่ท่านได้ทำการสมัครไว้</p>
                        <p><input type="E-mail" name="E-mail"><input type="submit" name="submit" onclick="myFunction()"></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
function myFunction() {
    alert("โปรตรวจสอบข้อความ E-mail ของท่าน");
}
</script>
<script>
